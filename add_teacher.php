...
if (isset($_POST['add_teacher'])) {
    ...
    if (empty($name) || empty($email) || empty($pass)) {
        ...
        if (mysqli_num_rows($check_result) > 0) {
            ...
            if (mysqli_query($conn, "INSERT INTO users (name, email, password, role) VALUES ('$name','$email','$pass','teacher')")) {
...
<div class="main-content">
    <div class="page-header">
        ...
        <p class="text-secondary">Register a new teacher in the system</p>
    </div>
    ...
    <div class="form-container">
        ...
        <form method="POST" class="modern-form" id="addTeacherForm">
    ...
    <div class="card" style="margin-top: 2rem;">
        ...
        <div class="recent-teachers">
            ...
            if (mysqli_num_rows($recent_teachers) > 0) {
                echo '<div class="recent-list">';
                while ($row = mysqli_fetch_assoc($recent_teachers)) {
                    echo '<div class="recent-item">';
                    echo '<div class="teacher-info">';
                    echo '<div class="teacher-avatar">' . strtoupper(substr($row['name'], 0, 2)) . '</div>';
                    echo '<div class="teacher-details">';
                    echo '<strong>' . htmlspecialchars($row['name']) . '</strong>';
                    echo '<span>' . htmlspecialchars($row['email']) . '</span>';
                    echo '</div>';
                    echo '</div>';
                    echo '<div class="teacher-meta">';
                    echo '<span class="role-badge">Teacher</span>';
                    echo '</div>';
                    echo '</div>';
                }
                echo '</div>';
            } else {
                echo '<p class="text-center text-secondary">No teachers added yet.</p>';
            }
            ?>
        </div>
    </div>
